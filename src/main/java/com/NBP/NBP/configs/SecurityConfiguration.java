...
public class SecurityConfiguration {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http, com.NBP.NBP.security.JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
